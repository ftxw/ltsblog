...
export default function CloudPlayer() {
  ...
  if (isLoading) {
    return (
      <div className="h-full w-full rounded-3xl bg-white/40 dark:bg-slate-800/50 backdrop-blur-md border border-white/40 dark:border-white/10 shadow-xl p-6 flex items-center justify-center min-h-[220px] md:min-h-[300px]">
  ...
  if (!currentSong) {
    return (
      <div
        ...
        className="h-full w-full rounded-3xl bg-white/40 dark:bg-slate-800/50 backdrop-blur-md border border-white/40 dark:border-white/10 shadow-xl p-6 flex flex-col items-center justify-center gap-4 min-h-[220px] md:min-h-[300px] cursor-pointer transition-all duration-700 hover:scale-[1.02] hover:shadow-2xl group"
      >
  ...
  return (
    <>
      ...
      <div
        onClick={() => router.push("/music")}
        className="h-full w-full rounded-3xl bg-white/40 dark:bg-slate-800/50 backdrop-blur-md border border-white/40 dark:border-white/10 shadow-xl p-4 md:p-6 flex flex-col justify-between transition-all duration-700 hover:scale-[1.02] relative group overflow-hidden cursor-pointer min-h-[220px] md:min-h-[300px]"
      >
        ...
        <div className="flex items-center gap-3 md:gap-5 relative z-10 mb-3 md:mb-6 mt-1 md:mt-2">
          ...
          >
            {/* eslint-disable-next-line @next/next/no-img-element -- 歌曲封面外链动态 URL，onError 切默认图 */}
            <img
              src={currentSong.cover || "/images/default-cover.webp"}
              alt="cover"
