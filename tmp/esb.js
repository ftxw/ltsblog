...
function Comments({
  ...
  const emojiBtnRectRef = useRef(null);
  useEffect(() => {
    if (!showEmoji) return;
  ...
  const inputArea = /* @__PURE__ */ jsxs("div", { className: kind === "project" ? "pt-1.5" : "", children: [
    /* @__PURE__ */ jsx(AnimatePresence, { children: composing && loggedIn && replyTo && /* @__PURE__ */ jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "pt-1 pb-1.5 pl-1 md:pl-1.5", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-center", children: [
      /* @__PURE__ */ jsxs(
        "div",
        {
          className: `flex-1 min-w-0 flex items-center gap-2 rounded-full bg-slate-100/80 dark:bg-slate-800/70 border pl-0.5 pr-2 md:pl-1 md:pr-2.5 py-0.5 md:py-1 transition-colors ${composing && loggedIn ? "border-indigo-300 dark:border-indigo-500/50" : "border-white/40 dark:border-white/10 hover:border-indigo-300 dark:hover:border-indigo-500/50"}`,
          children: [
        ...
        "div",
        {
          ...
          children: /* @__PURE__ */ jsx(
            "div",
            {
              ...
              children: EMOJIS.map((e) => /* @__PURE__ */ jsx(
                "button",
                {
                  type: "button",
